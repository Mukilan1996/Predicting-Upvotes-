# -*- coding: utf-8 -*-
"""
Created on Wed Jun  5 06:10:25 2019
...
#Loading the data
train = pd.read_csv("train_upvotes.csv")
train.shape
...
test = pd.read_csv("test_upvotes.csv")
...
#To CSV
finalData.to_csv("Predicted_Upvotes_Test_Data.csv",index = False)
